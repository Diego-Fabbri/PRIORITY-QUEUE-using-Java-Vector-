...
public class Sort {
	...
	public static void heapSort(double[] A) {
		...
		System.out.println(H);//stama il vettore H riodrinato , scrittura ammissibile si è implementato metodo toString
		...
		for (int i=0; i<A.length; i++) {//scandisce il vettore A che andava ordinato
			A[i] = H.deleteMin(); // copia nel vettore A gli elementi ordinati del vettore H , facendo riferimento alla funzione deleteMin della classe 
			                     // coda di priorità che elimina la testa del vettore ordinato e lo restituisce. Cosi facendo a fine ciclo il vettore A sarà ordinato
		}
	}
